...
<body>
  ...
  <!-- Top navbar -->
    ...
    <section class="section">
      ...
      <div class="container">
        <div class="columns">
          <!-- break the sections down into columns containing each element -->
          <div class="column is-one-quater">
            <!-- component menu on left -->
            <div class="card">
          ...
          <article class="message is-primary">
            ...
            <div class="message-body">
              Go to <a href="https://github.com/">github.com</a> and create an account.
              <br>
              That's where you'll be able to share your work with the world.. thats where we will be putting all of our code for this class.
            ...
            <form action="" class="box">
              ...
              <form class="box">
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="name" placeholder="Text Input">
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <p class="control has-icons-left has-icons-right">
                    <input class="input is-success" type="username" placeholder="Bulma">
              ...
              <!-- message input -->
                ...
                <!-- submit button -->
                <button class="button is-link">Sumbit</button>
          ...
          <div class="column is-one-quarter">
            <!-- table of contents section on the right -->
